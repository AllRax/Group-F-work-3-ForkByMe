    ...
    stages {
        ...
        stage("Deploy") {
            steps {
                ...
                bat '''
                "C:/Program Files/butler.exe" push target/"C:/Users/DELL/OneDrive/Desktop/itchTest/Group-F-work-3-ForkByMe/Group-F-work-3-ForkByMe.jar" allrax/projectf:windows
                '''
            }
        }
    }
